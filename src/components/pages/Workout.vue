...
// use ref to create a reactive variable that can be used in the template
const exerciseDescription = computed(() => exerciseDescriptions[selectedExercise.value]);
// computed is a function that takes a function as an argument and returns a reactive variable that will update when the value of the function changes

function handleCloseModal() {
  selectedExercise.value = null; // set the selected exercise to null to close the modal
}
</script>
