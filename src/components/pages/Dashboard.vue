...
// generate a random whole interger number between 0 and the length of the array
  ...
  <section id="dashboard">
    <div class="card tip-container">
      ...
      <button
        @click="
          () =>
            handleSelectWorkout(firstIncompleteWorkoutIndex < 0 ? 0 : firstIncompleteWorkoutIndex)
        "
      >
        Start workout &rarr;
      </button>
